...
export default class PasswordInputScreen extends Scene {
    ...
    render() {
        ...
        this.game.writeTextToCanvas('2. Use a password that has at least 12 characters, use at least one number, one uppercase letter, one lowercase letter and one special symbol.', (this.game.canvas.width / 2), (this.game.canvas.height / 2) + 20 + 25, 25, 'red');
