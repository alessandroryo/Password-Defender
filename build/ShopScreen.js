...
export default class ShopScreen extends Scene {
    ...
    render() {
        ...
        this.game.ctx.drawImage(this.cookieImage, (this.game.canvas.width / 6), ((this.mainLogo.height / 4.5) / 2) - (this.cookieImage.height / 2));
        this.game.writeTextToCanvas(localStorage.getItem('vault'), (this.game.canvas.width / 6) + (this.cookieImage.width + 5), ((this.mainLogo.height / 4.5) / 2) + 12, 45, 'white', 'left');
        if (this.error === true) {
        ...
        if (selcetedSkin1.path === selected) {
            this.game.writeTextToCanvas('Selected', canvasWidth * 0.25, canvasHeight * 0.2 + ((32 * 2.5) + 90), 20, 'rgb(244, 232, 137)');
        }
        else {
        ...
        if (selcetedSkin2.path === selected) {
            this.game.writeTextToCanvas('Selected', canvasWidth * 0.5, canvasHeight * 0.2 + ((32 * 2.5) + 90), 20, 'rgb(244, 232, 137)');
        }
        else {
        ...
        if (selcetedSkin3.path === selected) {
            this.game.writeTextToCanvas('Selected', canvasWidth * 0.75, canvasHeight * 0.2 + ((32 * 2.5) + 90), 20, 'rgb(244, 232, 137)');
        }
        else {
        ...
        if (selcetedSkin4.path === selected2) {
            this.game.writeTextToCanvas('Selected', canvasWidth * 0.25, canvasHeight * 0.55 + ((32 * 2.5) + 90), 20, 'rgb(244, 232, 137)');
        }
        else {
        ...
        if (selcetedSkin5.path === selected2) {
            this.game.writeTextToCanvas('Selected', canvasWidth * 0.5, canvasHeight * 0.55 + ((32 * 2.5) + 90), 20, 'rgb(244, 232, 137)');
        }
        else {
        ...
        if (selcetedSkin6.path === selected2) {
            this.game.writeTextToCanvas('Selected', canvasWidth * 0.75, canvasHeight * 0.55 + ((32 * 2.5) + 90), 20, 'rgb(244, 232, 137)');
        }
        else {
